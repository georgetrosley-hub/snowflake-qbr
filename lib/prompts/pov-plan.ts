...
export function buildPovPlanGenerationPrompt(priorityAccount: PriorityAccount, plan: PovPlan): string {
  ...
  return [
    ...
    "- Exit criteria: " + plan.exitCriteria.join(" | "),
    "- Competitive landmines: " + plan.competitiveLandmines.join(" | "),
    ...
    "",
    "### Exit criteria",
    "List 3–5 decision gates (stop/approve/pivot).",
    "",
    "### Competitive landmines",
    "List 3–5 likely counter-moves and the preemptive move for each.",
    "",
