  ...
  return (
    <div className="min-h-[100dvh] overflow-x-hidden bg-surface pb-[env(safe-area-inset-bottom)] lg:flex lg:h-screen">
      ...
      <div className="relative flex min-w-0 flex-1 flex-col overflow-hidden">
        <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(ellipse_85%_55%_at_100%_-10%,rgb(41_181_232/0.045),transparent_55%)]" />
        <div className="pointer-events-none absolute inset-x-0 top-0 h-px bg-gradient-to-r from-transparent via-surface-border/60 to-transparent" />
        ...
        <main
          ...
          className="relative flex-1 overflow-y-auto overflow-x-hidden px-5 py-9 sm:px-8 sm:py-10 lg:px-12 lg:py-11 xl:px-14 xl:py-12"
        >
