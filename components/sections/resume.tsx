...
const RESUME = {
  ...
  summary: `Enterprise SaaS seller with $35M+ in career revenue and consistent quota overperformance (118% to 157% across measured periods) specializing in enterprise security and infrastructure platforms sold into regulated industries. Deep experience selling category-shifting technology against entrenched legacy vendors (KnowBe4, Proofpoint, legacy auth/fraud providers) by reframing the problem from compliance checkbox to measurable risk reduction. Create executive urgency around emerging security threats while positioning platform consolidation over fragmented point products. Navigate multi-threaded buying cycles across CISO, VP Security, IT, GRC/Compliance, HR/Recruiting and executive leadership.
